...
func _process(_delta):
	if Signal_Bus.debug_music_mute:
		$Arcade_Cabinet/Music_ABadguyLooped.volume_db = -60
		$Container_Music/Music_Dnb.volume_db = -40
	else:
		$Arcade_Cabinet/Music_ABadguyLooped.volume_db = 0
		$Container_Music/Music_Dnb.volume_db = 0
